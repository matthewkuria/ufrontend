                    ...
                    <div className="flex flex-col text-white w-full md:w-1/2 p-3">
                        ...
                        <div className="flex justify-around md:justify-between mt-10 ">
                            <div className="flex flex-col">
                                ...
                                <Link href={`/technical-bench/${item.benchUrl}`} className='flex justify-center bg-white py-2 px-2  rounded-lg hover:underline hover:bg-blue-900 hover:text-white text-red-500'>Explore</Link>
                            </div>
                            <div className="flex flex-col">
                                <p className="uppercase">Team</p>
                                 <Link href={`teams/${item.playersUrl}`} className='bg-blue-900 py-2 px-3  rounded-lg hover:bg-white hover:underline hover:text-red-500'>View</Link>
                            </div>
                        </div>
                    </div>
                </div>
