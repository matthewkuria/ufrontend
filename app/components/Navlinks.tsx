...
export default function Navlinks() {
    return (
        <ul className="md:flex justify-between font-bold text-blue-900  gap-5 hidden">
            ...
            <li className="hover:text-red-500 py-6"><Link href="/videos">Videos</Link></li>
            <li className="hover:text-red-500 py-6"><Link href="/membership">Membership</Link></li>
            ...
            <li className="hover:text-red-500 py-6"><Link href="/teams">Teams</Link></li>
            <li className="hover:text-red-500 py-6"><Link href="/support">Donations</Link></li>
            <li className="hover:text-red-500 py-6"><Link href="/special-relay">Special Relay</Link></li>
